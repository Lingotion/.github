...
![choose-actor screenshot](./pics/choose-actor.png?raw=true "choose-actor screenshot")
...
At the bottom of each actor card you will find audio samples for each of their supported languages, generated using that specific Character.
